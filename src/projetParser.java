// $ANTLR 3.5.2 projet.g 2018-02-09 15:36:08
...
public class projetParser extends Parser {
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,13,FOLLOW_13_in_vars371); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_decproc_in_decprocs421);
					decproc();
					state._fsp--;

					pushFollow(FOLLOW_ptvg_in_decprocs423);
					ptvg();
					state._fsp--;
	...
	public final void decproc() throws RecognitionException {
		try {
			...
			{
			match(input,47,FOLLOW_47_in_decproc439); 
			pushFollow(FOLLOW_ident_in_decproc442);
			ident();
			state._fsp--;
			...
			switch (alt17) {
				case 1 :
					// projet.g:80:27: parfixe
					{
					pushFollow(FOLLOW_parfixe_in_decproc445);
					parfixe();
					state._fsp--;
			...
			switch (alt18) {
				case 1 :
					// projet.g:80:36: parmod
					{
					pushFollow(FOLLOW_parmod_in_decproc448);
					parmod();
					state._fsp--;
		...
		try {
			...
			switch (alt21) {
				case 1 :
					// projet.g:83:9: ';'
					{
					match(input,17,FOLLOW_17_in_ptvg472); 
					}
					break;
				case 2 :
					// projet.g:85:3: 
	...
	public final void corps() throws RecognitionException {
		try {
			...
			{
			match(input,29,FOLLOW_29_in_corps490); 
			pushFollow(FOLLOW_instructions_in_corps492);
			instructions();
			state._fsp--;

			match(input,39,FOLLOW_39_in_corps494); 
			}
	...
	public final void parfixe() throws RecognitionException {
		try {
			...
			{
			match(input,40,FOLLOW_40_in_parfixe506); 
			match(input,9,FOLLOW_9_in_parfixe508); 
			...
			while (true) {
				...
				case 1 :
					// projet.g:90:26: ';' pf
					{
					match(input,17,FOLLOW_17_in_parfixe514); 
	...
	public final void pf() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_type_in_pf534);
			type();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_pf541); 
	...
	public final void parmod() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_parmod561); 
			match(input,9,FOLLOW_9_in_parmod563); 
			pushFollow(FOLLOW_pm_in_parmod565);
			pm();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					// projet.g:96:26: ';' pm
					{
					match(input,17,FOLLOW_17_in_parmod569); 
	...
	public final void pm() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_type_in_pm589);
			type();
			state._fsp--;

			pushFollow(FOLLOW_ident_in_pm591);
			ident();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_pm596); 
	...
	public final void instructions() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_instruction_in_instructions617);
			instruction();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,17,FOLLOW_17_in_instructions621); 
		...
		try {
			...
			switch (alt27) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_inssi_in_instruction640);
					inssi();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_inscond_in_instruction646);
					inscond();
					state._fsp--;
				...
				case 3 :
					...
					{
					pushFollow(FOLLOW_boucle_in_instruction652);
					boucle();
					state._fsp--;
				...
				case 4 :
					...
					{
					pushFollow(FOLLOW_lecture_in_instruction658);
					lecture();
					state._fsp--;
				...
				case 5 :
					...
					{
					pushFollow(FOLLOW_ecriture_in_instruction664);
					ecriture();
					state._fsp--;
				...
				case 6 :
					...
					{
					pushFollow(FOLLOW_affouappel_in_instruction670);
					affouappel();
					state._fsp--;
	...
	public final void inssi() throws RecognitionException {
		try {
			...
			{
			match(input,50,FOLLOW_50_in_inssi687); 
			pushFollow(FOLLOW_expression_in_inssi689);
			expression();
			state._fsp--;

			match(input,24,FOLLOW_24_in_inssi691); 
			pushFollow(FOLLOW_instructions_in_inssi693);
			instructions();
			state._fsp--;
			...
			match(input,41,FOLLOW_41_in_inssi703); 
			}
	...
	public final void inscond() throws RecognitionException {
		try {
			...
			{
			match(input,27,FOLLOW_27_in_inscond717); 
			pushFollow(FOLLOW_expression_in_inscond720);
			expression();
			state._fsp--;

			match(input,15,FOLLOW_15_in_inscond723); 
			pushFollow(FOLLOW_instructions_in_inscond725);
			instructions();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_inscond739); 
					pushFollow(FOLLOW_expression_in_inscond742);
					expression();
					state._fsp--;

					match(input,15,FOLLOW_15_in_inscond745); 
					pushFollow(FOLLOW_instructions_in_inscond747);
					instructions();
					state._fsp--;
			...
			switch (alt30) {
				case 1 :
					...
					{
					match(input,25,FOLLOW_25_in_inscond764); 
			...
			match(input,38,FOLLOW_38_in_inscond785); 
			}
	...
	public final void boucle() throws RecognitionException {
		try {
			...
			{
			match(input,52,FOLLOW_52_in_boucle800); 
			pushFollow(FOLLOW_expression_in_boucle803);
			expression();
			state._fsp--;

			match(input,35,FOLLOW_35_in_boucle805); 
			pushFollow(FOLLOW_instructions_in_boucle807);
			instructions();
			state._fsp--;
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,42,FOLLOW_42_in_lecture822); 
			match(input,9,FOLLOW_9_in_lecture824); 
			pushFollow(FOLLOW_ident_in_lecture826);
			ident();
			state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,13,FOLLOW_13_in_ecriture861); 
	...
	public final void affouappel() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_ident_in_affouappel885);
			ident();
			state._fsp--;
			...
			switch (alt35) {
				case 1 :
					...
					pushFollow(FOLLOW_expression_in_affouappel895);
					expression();
					state._fsp--;
				...
				case 2 :
					...
					switch (alt34) {
						case 1 :
							...
							{
							pushFollow(FOLLOW_effixes_in_affouappel915);
							effixes();
							state._fsp--;
							...
							switch (alt33) {
								case 1 :
									...
									{
									pushFollow(FOLLOW_effmods_in_affouappel918);
									effmods();
									state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			{
			match(input,9,FOLLOW_9_in_effixes950); 
			...
			switch (alt37) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_expression_in_effixes953);
					expression();
					state._fsp--;
		...
		try {
			...
			switch (alt42) {
				...
				case 2 :
					// projet.g:153:5: exp3
					{
					pushFollow(FOLLOW_exp3_in_exp21068);
					exp3();
					state._fsp--;
	...
	public final void exp3() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp4_in_exp31084);
			exp4();
			state._fsp--;
			...
			switch (alt43) {
				case 1 :
					// projet.g:157:5: '=' exp4
					{
					match(input,21,FOLLOW_21_in_exp31091); 
				...
				case 2 :
					// projet.g:158:5: '<>' exp4
					{
					match(input,20,FOLLOW_20_in_exp31102); 
				...
				case 3 :
					// projet.g:159:5: '>' exp4
					{
					match(input,22,FOLLOW_22_in_exp31112); 
				...
				case 5 :
					// projet.g:161:5: '<' exp4
					{
					match(input,18,FOLLOW_18_in_exp31133); 
	...
	public final void exp4() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_exp5_in_exp41169);
			exp5();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp41181); 
					pushFollow(FOLLOW_exp5_in_exp41184);
					exp5();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,14,FOLLOW_14_in_exp41196); 
					pushFollow(FOLLOW_exp5_in_exp41199);
					exp5();
					state._fsp--;
	...
	public final void exp5() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_primaire_in_exp51225);
			primaire();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,11,FOLLOW_11_in_exp51241); 
				...
				case 2 :
					...
					{
					match(input,31,FOLLOW_31_in_exp51260); 
					pushFollow(FOLLOW_primaire_in_exp51263);
					primaire();
					state._fsp--;
		...
		try {
			...
			switch (alt46) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1287);
					valeur();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_ident_in_primaire1294);
					ident();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,9,FOLLOW_9_in_primaire1302); 
					pushFollow(FOLLOW_expression_in_primaire1304);
					expression();
					state._fsp--;
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_nbentier_in_valeur1320);
					nbentier();
					state._fsp--;
				...
				case 2 :
					...
					{
					match(input,12,FOLLOW_12_in_valeur1327); 
					pushFollow(FOLLOW_nbentier_in_valeur1329);
					nbentier();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,14,FOLLOW_14_in_valeur1336); 
				...
				case 4 :
					// projet.g:186:5: 'vrai'
					{
					match(input,54,FOLLOW_54_in_valeur1345); 
					}
					break;
				case 5 :
					// projet.g:187:5: 'faux'
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			// projet.g:197:15: INT
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier1381); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			// projet.g:199:9: ID
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident1392); 
	...
	public static final BitSet FOLLOW_13_in_vars371 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_vars374 = new BitSet(new long[]{0x0000000204022000L});
	public static final BitSet FOLLOW_ptvg_in_vars380 = new BitSet(new long[]{0x0000000204000002L});
	public static final BitSet FOLLOW_decproc_in_decprocs421 = new BitSet(new long[]{0x0000800000020000L});
	public static final BitSet FOLLOW_ptvg_in_decprocs423 = new BitSet(new long[]{0x0000800000000002L});
	public static final BitSet FOLLOW_47_in_decproc439 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_decproc442 = new BitSet(new long[]{0x0020090030000000L});
	public static final BitSet FOLLOW_parfixe_in_decproc445 = new BitSet(new long[]{0x0020080030000000L});
	public static final BitSet FOLLOW_parmod_in_decproc448 = new BitSet(new long[]{0x0020000030000000L});
	public static final BitSet FOLLOW_consts_in_decproc451 = new BitSet(new long[]{0x0020000020000000L});
	public static final BitSet FOLLOW_vars_in_decproc454 = new BitSet(new long[]{0x0000000020000000L});
	public static final BitSet FOLLOW_corps_in_decproc457 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_17_in_ptvg472 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_29_in_corps490 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_corps492 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_39_in_corps494 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_40_in_parfixe506 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_parfixe508 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pf_in_parfixe510 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_17_in_parfixe514 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pf_in_parfixe516 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_10_in_parfixe520 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pf534 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf536 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_13_in_pf541 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf543 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_43_in_parmod561 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_parmod563 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pm_in_parmod565 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_17_in_parmod569 = new BitSet(new long[]{0x0000000204000000L});
	public static final BitSet FOLLOW_pm_in_parmod571 = new BitSet(new long[]{0x0000000000020400L});
	public static final BitSet FOLLOW_10_in_parmod575 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pm589 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm591 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_13_in_pm596 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm598 = new BitSet(new long[]{0x0000000000002002L});
	public static final BitSet FOLLOW_instruction_in_instructions617 = new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_17_in_instructions621 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instruction_in_instructions623 = new BitSet(new long[]{0x0000000000020002L});
	public static final BitSet FOLLOW_inssi_in_instruction640 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_inscond_in_instruction646 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_boucle_in_instruction652 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_lecture_in_instruction658 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ecriture_in_instruction664 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_affouappel_in_instruction670 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_50_in_inssi687 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inssi689 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_24_in_inssi691 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inssi693 = new BitSet(new long[]{0x0008020000000000L});
	public static final BitSet FOLLOW_51_in_inssi696 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inssi699 = new BitSet(new long[]{0x0000020000000000L});
	public static final BitSet FOLLOW_41_in_inssi703 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_27_in_inscond717 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inscond720 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_inscond723 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond725 = new BitSet(new long[]{0x0000004002002000L});
	public static final BitSet FOLLOW_13_in_inscond739 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_inscond742 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_15_in_inscond745 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond747 = new BitSet(new long[]{0x0000004002002000L});
	public static final BitSet FOLLOW_25_in_inscond764 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_inscond767 = new BitSet(new long[]{0x0000004000000000L});
	public static final BitSet FOLLOW_38_in_inscond785 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_52_in_boucle800 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_boucle803 = new BitSet(new long[]{0x0000000800000000L});
	public static final BitSet FOLLOW_35_in_boucle805 = new BitSet(new long[]{0x0014040108020020L});
	public static final BitSet FOLLOW_instructions_in_boucle807 = new BitSet(new long[]{0x0000001000000000L});
	public static final BitSet FOLLOW_36_in_boucle809 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_42_in_lecture822 = new BitSet(new long[]{0x0000000000000200L});
	public static final BitSet FOLLOW_9_in_lecture824 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture826 = new BitSet(new long[]{0x0000000000002400L});
	...
	public static final BitSet FOLLOW_13_in_ecriture861 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_ecriture863 = new BitSet(new long[]{0x0000000000002400L});
	public static final BitSet FOLLOW_10_in_ecriture869 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel885 = new BitSet(new long[]{0x0000000000010202L});
	public static final BitSet FOLLOW_16_in_affouappel893 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_affouappel895 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_effixes_in_affouappel915 = new BitSet(new long[]{0x0000000000000202L});
	public static final BitSet FOLLOW_effmods_in_affouappel918 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_effixes950 = new BitSet(new long[]{0x0040202000005660L});
	public static final BitSet FOLLOW_expression_in_effixes953 = new BitSet(new long[]{0x0000000000002400L});
	...
	public static final BitSet FOLLOW_exp3_in_exp21068 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp4_in_exp31084 = new BitSet(new long[]{0x0000000000FC0002L});
	public static final BitSet FOLLOW_21_in_exp31091 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31095 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_20_in_exp31102 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31105 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_22_in_exp31112 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31116 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_23_in_exp31123 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31126 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_exp31133 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31137 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_19_in_exp31144 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp4_in_exp31147 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_exp5_in_exp41169 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_12_in_exp41181 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp5_in_exp41184 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_14_in_exp41196 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_exp5_in_exp41199 = new BitSet(new long[]{0x0000000000005002L});
	public static final BitSet FOLLOW_primaire_in_exp51225 = new BitSet(new long[]{0x0000000080000802L});
	public static final BitSet FOLLOW_11_in_exp51241 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_primaire_in_exp51245 = new BitSet(new long[]{0x0000000080000802L});
	public static final BitSet FOLLOW_31_in_exp51260 = new BitSet(new long[]{0x0040002000005260L});
	public static final BitSet FOLLOW_primaire_in_exp51263 = new BitSet(new long[]{0x0000000080000802L});
	public static final BitSet FOLLOW_valeur_in_primaire1287 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire1294 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_9_in_primaire1302 = new BitSet(new long[]{0x0040202000005260L});
	public static final BitSet FOLLOW_expression_in_primaire1304 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_primaire1306 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1320 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_12_in_valeur1327 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1329 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_14_in_valeur1336 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1338 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_54_in_valeur1345 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_37_in_valeur1352 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier1381 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident1392 = new BitSet(new long[]{0x0000000000000002L});
}
